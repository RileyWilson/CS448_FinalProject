...
const getData = async() => {
    ...
    var rawData =  await d3.csv('lib/data/TermsCombined_withDate.csv', function(d) {
        return { 
            term: d.term,
            count: +d.count,
    ...
    var allTermData =  await d3.json('lib/data/TermsObject.json');

    var topTerms = ["coronavirus", "virus", "trump", "mask", "spread", "face", "death", "home", "safe", "sick", "people"]
