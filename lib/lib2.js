...
const getData = async() => {
    //var termsData = d3.csv("lib/data/frequent_terms.csv");
    //console.log(termsData)
    //var terms = JSON.parse("lib/data/frequent_terms.json");
    ...
    let obj = {terms: termsData.slice(0, 130)/*, bigrams: bigrams, trigrams: trigrams*/};
    console.log("obj:" + obj)
    return obj;
}
