...
function getTweetData(term, n){
    var allTweetData = [];
    if (n == 1){ // term
        allTweetData =  await d3.json('lib/data/twitter/twitter_terms.json');
    } else if (n == 2){ // bigram
        allTweetData =  await d3.json('lib/data/twitter/twitter_bigrams.json');
    } else if (n == 3){ // trigram
        allTweetData =  await d3.json('lib/data/twitter/twitter_trigrams.json');
    }
